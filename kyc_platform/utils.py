...
def run_agent(
    ...
    For server-side tools (web_search_20260209 / web_fetch_20260209) Claude
    runs the search loop automatically.  We only need to handle `pause_turn`
    (server loop hit its iteration limit) by re-sending the conversation.
